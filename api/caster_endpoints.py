...
@router.post("/", response_model=CasterType)
...
@router.get("/{caster_type_id}", response_model=CasterType)
...
@router.put("/{caster_type_id}", response_model=CasterType)
...
@router.get("/", response_model=List[CasterType])
